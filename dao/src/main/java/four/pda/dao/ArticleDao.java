...
public class ArticleDao extends AbstractDao<Article, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property LabelName = new Property(10, String.class, "labelName", false, "LABEL_NAME");
        public final static Property LabelColor = new Property(11, String.class, "labelColor", false, "LABEL_COLOR");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ARTICLE\" (" + //
                ...
                "\"LABEL_NAME\" TEXT," + // 10: labelName
                "\"LABEL_COLOR\" TEXT);"); // 11: labelColor
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Article entity) {
        ...
        if (labelName != null) {
            stmt.bindString(11, labelName);
        }
 
        String labelColor = entity.getLabelColor();
        if (labelColor != null) {
            stmt.bindString(12, labelColor);
        }
    }
    ...
    public Article readEntity(Cursor cursor, int offset) {
        Article entity = new Article( //
            ...
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // labelName
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11) // labelColor
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Article entity, int offset) {
        ...
        entity.setLabelName(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
        entity.setLabelColor(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
     }
